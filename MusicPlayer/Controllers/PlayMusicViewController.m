...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //[Utils addBlurToView:self.cover];
...
- (void)setupUI
{
    ...
    self.equalizerView = [[EqualizerView alloc]initWithFrame:CGRectMake(self.eqButton.frame.origin.x - 260, self.eqButton.frame.origin.y - 280, 260, 280)];
